...
config_path = "sims_1pw/gaussian_ft600_highres/sim_config.py"
if not config_path:
...
def laser_by(y, z, t):
    return bowl_shaped_pulse(y, z, t)

def laser_bz(y, z, t):
    return 1j * bowl_shaped_pulse(y, z, t)
...
def foil_shape_profile():
    return foil_shapes.get_foils(
        sim_params.n0,
        ...
        microns_to_norm_units(sim_params.centery),
        microns_to_norm_units(sim_params.centerz),
...
fields = ["Ey", "Ex", "Bz", "Rho_hydrogen_ions", "Rho_hydrogen_electrons"]
...
DiagParticleBinning(
    ...
    species=["hydrogen_ions"],
    axes=[
        [energy_cylinder_small, 0, 220, 1000],
    ],
)
...
DiagParticleBinning(
    deposited_quantity="weight",
    every=[16000, 16081, 20],
    time_average=1,
    species=["hydrogen_ions"],
    axes=[
        ["y", Lsim[1]/2. - microns_to_norm_units(5.), Lsim[1]/2. + microns_to_norm_units(5.), 200],
        [divergence_y, -np.pi, np.pi, 400],
        ["ekin", 0, 300, 400]
    ],
)
